...
class GoalCard extends StatelessWidget {
  ...
  const GoalCard({Key? key, required this.goal, required this.onDelete})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: 300, // Фиксированная высота для всех карточек
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            overflow:
                TextOverflow.ellipsis, // Добавление многоточия при переполнении
          ),
          ...
          Expanded(
            child: Text(
              ...
              maxLines: 3, // Ограничение количества строк
